...
L["Matcher_BlackhandTrinket_ArgOrder"] = "Korean no available" -- Needs review
L["Matcher_BlackhandTrinket_Pattern"] = "Korean no available" -- Needs review
L["Matcher_BonusArmor_ArgOrder"] = "value"
L["Matcher_BonusArmor_Pattern"] = "Korean no available" -- Needs review
L["Matcher_ICD2_ArgOrder"] = "duration stat value chance cd"
L["Matcher_ICD2_Pattern"] = "Korean no available" -- Needs review
L["Matcher_ICD_ArgOrder"] = "duration stat value chance cd"
L["Matcher_ICD_Pattern"] = "Korean no available" -- Needs review
L["Matcher_InsigniaOfConquest_ArgOrder"] = "duration stat value"
L["Matcher_InsigniaOfConquest_Pattern"] = "Korean no available" -- Needs review
...
L["Matcher_RPPM_Pattern"] = "^착용 효과: 공격 시 일정 확률로 (%d+)초 동안 (.-)이 ([%d,%. ]+)만큼 증가합니다%. %(분당 약 ([%d,%. ]+)번 발동%)$" -- Needs review
L["Matcher_SoliumBand_ArgOrder"] = "duration type ppm"
L["Matcher_SoliumBand_BuffType_Greater"] = "상급"
L["Matcher_SoliumBand_Pattern"] = "Korean no available" -- Needs review
L["Matcher_StatTooltipParser_Armor"] = "^(RESISTANCE0_NAME) (%d+)$" -- Needs review
L["Matcher_StatTooltipParser_DPS"] = "^%((.-) ([%d,%. ]+)%)$" -- Needs review
L["Matcher_StatTooltipParser_Stat"] = "^(.-) %+(%d+)$" -- Needs review
...
L["Matcher_Use2_Pattern"] = "^사용 효과: (%d+)초 동안 (.-)이 ([%d,%. ]+)만큼 증가합니다%.$" -- Needs review
L["Matcher_Use_ArgOrder"] = "stat duration value cd"
L["Matcher_Use_Pattern"] = "Korean no available" -- Needs review
...
L["Options_EnableCmMode_Label"] = "도전모드 사용(미작동)" -- Needs review
L["Options_EnableCmMode_Tooltip"] = "도전 모드 던전에서, 능력치를 툴팁에서 직접 읽습니다 - 도전모드에서의 정확한 능력치. 이 옵션을 켜면 도전 모드 던전 안에서 쉬프트 키를 눌렀을 때만 작동합니다.(한글 클라이언트 미작동)" -- Needs review
...
L["Options_Specialization_Tooltip"] = "능력치 중요도 세트의 이름" -- Needs review
