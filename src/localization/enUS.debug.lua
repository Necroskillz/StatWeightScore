...
L["Options_SuggestUniqueGem_Label"] = "Suggest primary stat gem";
L["Options_SuggestUniqueGem_Tooltip"] = "Suggets epic unique-equipped (1) primary stat gem if it's not already equipped on one of your items.";
