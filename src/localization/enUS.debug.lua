...
L["Options_SuggestSabersEye_Label"] = "Suggest Saber's Eye";
L["Options_SuggestSabersEye_Tooltip"] = "Suggets epic unique-equipped (1) +200 primary stat gem Saber's Eye of Agility/Strength/Intelect if it's not already equipped on one of your items.";
