...
L["Options_AssociatedSet_Label"] = "Associated Equipment Set";
L["Options_AssociatedSet_Tooltip"] = "Comparison to items in this equipment set instead";
L["Options_SuggestKrakensEye_Label"] = "Suggest Kraken's Eye";
L["Options_SuggestKrakensEye_Tooltip"] = "Suggets epic unique-equipped (1) +40 primary stat gem Kraken's Eye of Agility/Strength/Intelect if it's not already equipped on one of your items.";
L["Options_CompactMode_Label"] = "Compact Mode";
L["Options_CompactMode_Tooltip"] = "Display minimalistic information in the tooltip (only spec name, score and diff). Holding ctrl key will display all information.";
L["Options_SpecColor_Label"] = "Color";
L["Options_SpecColor_Tooltip"] = "Tooltip text color";
L["Options_SpecIcon_Label"] = "Icon";
L["Options_SpecIcon_Tooltip"] = "Tooltip icon";
L["Warning"] = "Warning";
